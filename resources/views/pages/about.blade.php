...
@section('content')
<div class="hero-section text-center py-5 mb-4" style="background: linear-gradient(135deg, #28a745, #20c997); border-radius: 20px; color: white;">
...
<div class="content-card">
  <div class="row">
    <div class="col-lg-6 mb-4">
      ...
      <p>Sekolah Kita adalah lembaga pendidikan yang berkomitmen mencetak generasi cerdas, berkarakter, dan siap menghadapi masa depan. Didirikan pada tahun 2000, sekolah ini telah melahirkan ribuan alumni berprestasi yang berkontribusi di berbagai bidang.</p>
